    ...
    $this->get("/deals/{$deal->getKey()}/timeline")
        ...
        ->assertInertia(function ($page): void {
            ...
            expect($explanation)->toContain('skipped')
                 ...
                 * first wording said "not required", under a badge reading
                 * **Not Met** — the sub-line saying the condition did not
                 * apply, beneath a badge saying somebody failed to satisfy it.
                 * Skipping a stage does not make its conditions optional; it
                 * means nobody evaluated them.
                 */
