...
<template>
    ...
    <div class="flex min-h-svh flex-col items-center justify-center gap-6 bg-background p-6">
        ...
        <div class="flex max-w-md flex-col gap-2 text-center">
            <h1 class="text-2xl font-semibold text-foreground">{{ $page.props.name }}</h1>
            <p class="text-sm text-muted-foreground">
                The process side of a real estate practice: workflows, stages, deadlines, and the
                client updates that follow from them.
            </p>
        </div>
